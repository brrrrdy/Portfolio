...
export function FooterNav() {
  ...
  footer.className =
    "w-full bg-orange-800 text-white py-10 px-12 flex justify-between items-start mt-auto";
  ...
  repoText.className =
    "text-orange-200 hover:text-white transition-colors duration-300";
  ...
  links.forEach((link) => {
    ...
    linkElement.className =
      "text-orange-200 hover:text-white transition-colors duration-300 text-sm";
